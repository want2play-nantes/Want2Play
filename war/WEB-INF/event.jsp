	...
	<p>
		...
		<form class="form-horizontal" role="form">
			<div class="form-group">
    			...
    			<div class="col-sm-10">
      				<p class="form-control-static">createur@gmail.com</p>
    			</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10 input-group">
					...
					<input type="time" class="form-control" id="inputHeure" placeholder="Date" required>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10 input-group">
					...
					<input type="text" class="form-control" id="inputLieu" placeholder="Soyez le plus précis possible" required>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10 input-group">
					...
					<input type="text" class="form-control" id="inputParticipants" placeholder="Nombre maximum de participants" required>
				</div>
			</div>
			<hr class="soften" />
